...
- Research QC scoring and validation table
- QC status chart and A/T/G/C heatmap
- Length and GC distribution charts
- Motif/pattern search with positions
- k-mer frequency analysis
- Codon usage analysis
- Restriction-site screening
- Simple Wallace-rule oligonucleotide Tm estimate
- Automated downloadable analysis report
